...
TEST(DynamicSliceTest, dynamic_slice_varied_types) {
  ...
  test1.Run(OpTester::ExpectResult::kExpectSuccess, "", {kPlaidMLExecutionProvider});
  //test1.Run();
  ...
  test2.Run(OpTester::ExpectResult::kExpectSuccess, "", {kPlaidMLExecutionProvider});
  //test2.Run();
  ...
  test3.Run(OpTester::ExpectResult::kExpectSuccess, "", {kPlaidMLExecutionProvider});
  //test3.Run();
#endif
  ...
  test4.Run(OpTester::ExpectResult::kExpectSuccess, "", {kPlaidMLExecutionProvider});
  //test4.Run();
  ...
  test5.Run(OpTester::ExpectResult::kExpectSuccess, "", {kPlaidMLExecutionProvider});
  //test5.Run();
}
